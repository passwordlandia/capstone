...
$servers->setValue('server','name','ITC-299 Example LDAP Server');
/* Examples:
   'ldap.example.com',
...
$servers->setValue('server','base',array('dc=itc299,dc=local'));
...
// $servers->setValue('login','bind_id','');
  $servers->setValue('login','bind_id','cn=ldapadm,dc=itc299,dc=local');
